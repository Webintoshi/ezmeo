    ...
    <div className={`relative ${className}`}>
      ...
      {isOpen && !disabled && (
        <>
          ...
          {/* Dropdown */}
          <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 z-20 animate-in fade-in slide-in-from-top-2 duration-200">
