...
export function Hero() {
  ...
  return (
    <section ref={sectionRef} className="relative h-[600px] md:h-[700px] lg:h-[800px] overflow-hidden bg-gray-100">
      {isVisible || !loading ? (
        <>
          {/* Slider Images */}
              ...
              <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-3 z-10">
                {slides.map((_, index) => (
                  <button
                    ...
                    className={`w-3 h-3 md:w-4 md:h-4 rounded-full transition-all ${index === currentSlide
